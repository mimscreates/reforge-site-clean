    ...
    <section className="py-16 px-4 bg-card">
      <div className="container mx-auto text-center max-w-xl">
        ...
        <div className="flex flex-col sm:flex-row gap-2 max-w-sm mx-auto">
          <Input type="email" placeholder="Your email" value={email} onChange={(e) => setEmail(e.target.value)} className="bg-background border-border text-foreground placeholder:text-muted-foreground rounded-full px-5 h-9 text-sm" />
          <Button variant="cta" className="rounded-full px-6 font-medium whitespace-nowrap h-9 text-sm">Subscribe</Button>
        </div>
      </div>
    </section>
  );
