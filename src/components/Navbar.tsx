...
const mobileNavGroups = [
  {
    label: "CREATE",
    items: [{ label: "Creator Packs", path: "/#creator-packs" }],
  },
  {
    label: "WORK WITH US",
    items: [
  ...
  {
    label: "STUDIO",
    items: [{ label: "Rent Your Space", path: "/rent-your-space" }],
  },
  {
    label: "CONTACT",
    items: [
      { label: "Request a Quote", path: "/devis" },
      { label: "Call Us", path: "tel:+21626934928", external: true },
    ],
  },
];
          ...
          >
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto px-5 py-6 space-y-6">
                {mobileNavGroups.map((group, gi) => (
                  <motion.div
                    ...
                    transition={{ delay: 0.1 + gi * 0.06, duration: 0.35 }}
                  >
                    <p className="text-[10px] font-bold tracking-[0.2em] text-muted-foreground/60 uppercase mb-3">
                      {group.label}
                    </p>
                        ...
                        if (isExternal) {
                          return (
                            <a
                              key={item.path}
                              href={item.path}
                              className="block py-2.5 px-2 rounded-lg hover:bg-secondary/50 transition-colors"
                            >
                              {content}
                            </a>
                          );
                        ...
                        if (isHash) {
                          return (
                            <button
                              ...
                              className="block w-full text-left py-2.5 px-2 rounded-lg hover:bg-secondary/50 transition-colors"
                            >
                              {content}
                            </button>
                          );
              ...
              <motion.div
                ...
                className="px-5 pb-6 pt-3 border-t border-border/50 space-y-2.5"
              >
                <a
                  href="tel:+21626934928"
                  className="flex items-center justify-center gap-2 w-full h-10 rounded-full border border-border bg-secondary/50 text-foreground text-sm font-medium hover:bg-secondary transition-colors"
                >
                ...
                >
                  <Button className="w-full rounded-full bg-primary text-primary-foreground hover:bg-primary/90 font-medium text-sm h-10">
                    Book a Session
                  </Button>
                </Link>
              </motion.div>
